...
int handle_append(int client_fd, const struct message *msg, server_role_t role, const char *port);

int handle_repl_append(int client_fd, const struct message *msg);
...
int handle_commit_append(int client_fd, const struct message *msg);
